<script lang="ts">
  ...
  import de from './imprint.de.html?raw'
  import en from './imprint.en.html?raw'
...
<svelte:head>
  <title>{m.legal_imprint_title()} - {name}</title>
  <meta name="description" content={m.legal_imprint_metaDescription({ name })} />
</svelte:head>
