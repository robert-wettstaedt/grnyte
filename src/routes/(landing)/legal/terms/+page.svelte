<script lang="ts">
  ...
  import de from './terms.de.html?raw'
  import en from './terms.en.html?raw'
...
<svelte:head>
  <title>{m.legal_terms_title()} - {name}</title>
  <meta name="description" content={m.legal_terms_metaDescription({ name })} />
</svelte:head>
