// @generated drizzle-zero signature:sha256:af867642e278fc85d2f843d19d0f909b54a01c72788f283d011656653c4d26c8
...
const areasTable = {
  ...
  columns: {
    ...
    type: {
      type: 'string',
      optional: true,
      customType: null as unknown as 'area' | 'sector',
    },
    walkingPaths: {
      type: 'json',
      optional: true,
...
const bunnyStreamsTable = {
  ...
  columns: {
    ...
    readiness: {
      type: 'string',
      optional: true,
      customType: null as unknown as 'pending' | 'ready' | 'failed',
    },
    source: {
      type: 'string',
      optional: true,
  ...
  columns: {
    ...
    verb: {
      ...
      customType: null as unknown as
        'update' | 'delete' | 'create' | 'add' | 'remove' | 'join' | 'leave' | 'invite' | 'accept',
    },
  },
  primaryKey: ['id'],
} as const
...
const feedbackTable = {
  ...
  columns: {
    ...
    kind: {
      type: 'string',
      optional: false,
      customType: null as unknown as 'regression' | 'bug' | 'idea' | 'other',
    },
    locale: {
      type: 'string',
      optional: true,
    ...
    status: {
      type: 'string',
      optional: true,
      customType: null as unknown as 'open' | 'closed',
    },
    userAgent: {
      type: 'string',
      optional: true,
