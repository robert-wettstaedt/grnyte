 ...
 *
 * Trimmed rather than length-checked: a whitespace name renders blank like an empty one. Not
 * branded `DisplayName`, because this reads a raw value out of the event log rather than an
 * entity's name off a mapper.
 */
