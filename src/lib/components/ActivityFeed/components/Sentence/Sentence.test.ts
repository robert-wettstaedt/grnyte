...
describe('Sentence.svelte', () => {
  ...
  describe('ascent activities (created)', () => {
    it('renders flash ascent sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('flashed')
    })
    ...
    it('renders send ascent sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('sent')
    })
    ...
    it('renders repeat ascent sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('repeated')
    })
    ...
    it('renders attempt ascent sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('attempted')
    })

    it('renders attempt ascent sentence with null user', () => {
      const ascentEntity: AscentEntity = {
        type: 'ascent',
        object: createAscent({ type: 'attempt' }),
      }
      ...
      const { container } = renderWithI18n(Sentence, {
        props: { activity: { ...activity, user: null }, withDetails: true },
      })
      expect(getTextContent(container)).toBe('Someone attempted')
    })

    it('renders attempt ascent sentence with user', () => {
      const ascentEntity: AscentEntity = {
        type: 'ascent',
        object: createAscent({ type: 'attempt' }),
      }
      ...
      expect(getTextContent(container)).toBe('testuser attempted')
    })
    ...
    it('renders ascent with parent route entity', () => {
      ...
      expect(text).toBe('flashed Test Route')
    })
    ...
    it('renders ascent with parent entity name (not route type)', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('sent Test Area')
    })
    ...
    it('renders ascent with breadcrumbs', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withBreadcrumbs: true } })
      expect(getTextContent(container)).toBe('flashed Test Area in Region >Sector')
    })
    ...
    it('renders ascent with grade opinion', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('flashed Personal opinion: 6a')
    })
    ...
    it('renders ascent with rating opinion', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('sent Personal opinion:')
    })
    ...
    it('renders ascent with temperature and humidity', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('flashed 18°C 65%')
    })
    ...
    it('renders ascent with temperature only', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('sent 22°C')
    })
    ...
    it('renders ascent with different date (shows relative time)', async () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('flashed 2 days ago')
    })
  })
  ...
  describe('with withDetails prop', () => {
    ...
    it('renders "Someone" when user is null and withDetails is true', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toContain('Someone')
    })
  })
  ...
  describe('user role activities', () => {
    it('renders user role created sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser approved approveduser to region Test Region')
    })
    ...
    it('renders user role created sentence with null user', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser approved a user to region Test Region')
    })
    ...
    it('renders user role updated sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser updated the role of updateduser to admin in region Test Region')
    })
    ...
    it('renders user role updated sentence with null user', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser updated the role of a user to maintainer in region Test Region')
    })
    ...
    it('renders user role deleted sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser removed removeduser from region Test Region')
    })
    ...
    it('renders user role deleted sentence with null user', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser removed a user from region Test Region')
    })
    ...
    it('renders user role created without region', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser approved newuser')
    })
  })
  ...
  describe('user invitation activities', () => {
    it('renders invitation created sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser invited invited@example.com to region Test Region')
    })
    ...
    it('renders invitation accepted sentence', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser accepted the invitation to join region Test Region')
    })
    ...
    it('renders invitation deleted sentence', () => {
      ...
      expect(getTextContent(container)).toBe(
        'testuser removed the invitation to removed@example.com from region Test Region',
      )
    })
    ...
    it('renders invitation created without region', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser invited test@example.com')
    })
  })
  ...
  describe('favorite activities', () => {
    it('renders favorite created sentence for route', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser added Favorite Route to their favorites')
    })
    ...
    it('renders favorite created sentence for non-route entity', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser added Favorite Area to their favorites')
    })
    ...
    it('renders favorite deleted sentence for route', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser removed Unfavorite Route from their favorites')
    })
    ...
    it('renders favorite deleted sentence for non-route entity', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('testuser removed Unfavorite Block from their favorites')
    })
  })
  ...
  describe('generic entity activities', () => {
    describe('area entity', () => {
      it('renders created area sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser created an area New Area')
      })
      ...
      it('renders updated area name sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the name of area Updated Area old text new text')
      })
      ...
      it('renders deleted area sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser deleted an area Deleted Area')
      })
    })
    ...
    describe('block entity', () => {
      it('renders created block sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser created a block New Block')
      })
      ...
      it('renders updated block name sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the name of block Test Block old text new text')
      })
    })
    ...
    describe('route entity', () => {
      it('renders created route sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser created a route New Route')
      })
      ...
      it('renders updated route grade sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the grade of route 6b Graded Route 6a 6b')
      })
      ...
      it('renders updated route grade with only newValue (no oldValue)', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the grade of route Graded Route 6b')
      })
      ...
      it('renders updated route grade with only oldValue (no newValue)', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the grade of route Graded Route 6a')
      })
      ...
      it('renders updated route rating sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the rating of route Rated Route')
      })
      ...
      it('renders updated route tags sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the tags of route Tagged Route old text new text')
      })
      ...
      it('renders updated route first ascent sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the first ascent of route FA Route old text new text')
      })
    })
    ...
    describe('file entity', () => {
      it('renders uploaded file sentence with columnName = null', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser uploaded a file')
      })
      ...
      it('renders uploaded file sentence with columnName = topo image', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser uploaded a topo image')
      })
    ...
    describe('ascent entity (non-created type)', () => {
      it('renders updated ascent notes sentence (own ascent)', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe(
          'testuser updated the notes of their own ascent of Test Ascent old text new text',
        )
      })
      ...
      it('renders updated ascent notes sentence (other user ascent)', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe(
          "testuser updated the notes of otheruser's ascent of Test Ascent old text new text",
        )
      })
      ...
      it('renders deleted ascent sentence', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser deleted an ascent of Deleted Ascent')
      })
    })
    ...
    describe('with parent entity', () => {
      it('renders entity with parent entity and breadcrumbs', () => {
        ...
        expect(getTextContent(container)).toBe('testuser created a route New Route in Area A >Sector B > Parent Block')
      })
      ...
      it('renders entity with parent route entity', () => {
        ...
        expect(getTextContent(container)).toBe(
          'testuser updated the notes of an ascent of Test Ascent in Area > Parent Route',
        )
      })
    })
    ...
    describe('value changes rendering', () => {
      it('renders old value with strikethrough for generic update', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the type of area Test Area "crag" "sector"')
      })
      ...
      it('renders only new value when old value is null', () => {
        ...
        const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
        expect(getTextContent(container)).toBe('testuser updated the topo of block Test Block "5"')
      })
  ...
  describe('edge cases', () => {
    it('handles activity with no user in withDetails mode', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: true } })
      expect(getTextContent(container)).toBe('Someone created an area Test Area')
    })
    ...
    it('handles multiple breadcrumb items', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withBreadcrumbs: true } })
      expect(getTextContent(container)).toBe('flashed Final Area in Region A >Sub Area >Sector X')
    })
    ...
    it('handles ascent with both grade and rating opinion', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity } })
      expect(getTextContent(container)).toBe('sent Personal opinion: 6b')
    })
    ...
    it('renders without withDetails prop (no username prefix)', () => {
      ...
      const { container } = renderWithI18n(Sentence, { props: { activity, withDetails: false } })
      expect(getTextContent(container)).toBe('created an area Test Area')
    })
  })
})
